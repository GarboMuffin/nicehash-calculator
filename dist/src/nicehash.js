...
var NiceHashCost = (function () {
    function NiceHashCost(endpoint, fixed) {
        this.endpoint = endpoint;
        this.fixed = fixed;
    }
    Object.defineProperty(NiceHashCost.prototype, "price", {
        get: function () {
    ...
    NiceHashCost.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request(this.endpoint)];
                    case 1:
                        response = _a.sent();
    ...
    NiceHashCost.prototype.filter = function () {
...
exports.NiceHashCost = NiceHashCost;
;
function createEndpoint(algo, location) {
