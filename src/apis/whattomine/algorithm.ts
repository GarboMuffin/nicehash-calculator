...
export class Algorithm {
  ...
  public static Skunkhash = new Algorithm(54);
  ...
  public static Scrypt = new Algorithm(500);
  public static "SHA-256" = new Algorithm(14000);
  public static Quark = new Algorithm(3300);
  public static NIST5 = new Algorithm(57);
  public static Lyra2RE = new Algorithm(14700);
  public static Qubit = new Algorithm(3300);
  public static "Blake (2s)" = new Algorithm(815);
  public static "Blake (2b)" = new Algorithm(815);
