export class HashRate {
  ...
  public static readonly GIGA = new HashRate(1000 * 1000, "GH");
  public static readonly TERA = new HashRate(1000 * 1000 * 1000, "TH");
  public static readonly PETA = new HashRate(1000 * 1000 * 1000 * 1000, "PH");
